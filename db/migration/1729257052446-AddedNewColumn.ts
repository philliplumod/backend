...
export class AddedNewColumn1729257052446 implements MigrationInterface {
    name = 'AddedNewColumn1729257052446'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "tbl_user" ("user_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "password" character varying NOT NULL, "first_name" character varying NOT NULL, "last_name" character varying NOT NULL, "status" boolean NOT NULL DEFAULT true, "role" character varying NOT NULL, "contact_no" character varying NOT NULL, "address" character varying NOT NULL, "birthdate" character varying NOT NULL, "gender" character varying NOT NULL, "license_no" character varying NOT NULL, "license_front" character varying NOT NULL, "license_back" character varying NOT NULL, "other_id" character varying NOT NULL, "other_id_no" character varying NOT NULL, "test" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_cfbcdcc1a279167103bbda66bd6" PRIMARY KEY ("user_id"))`);
        await queryRunner.query(`CREATE TABLE "tbl_motor" ("motor_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "color" character varying NOT NULL, "plate_no" character varying NOT NULL, "price" integer NOT NULL, "model" character varying NOT NULL, "description" character varying NOT NULL, "isVisible" boolean NOT NULL DEFAULT false, "isDelete" boolean NOT NULL DEFAULT false, "brand_id" uuid, CONSTRAINT "PK_82bb67cecdf8a564b2c59c10c11" PRIMARY KEY ("motor_id"))`);
        await queryRunner.query(`CREATE TABLE "tbl_motor_brand" ("brand_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "brand_name" character varying NOT NULL, CONSTRAINT "PK_a84ad4086556a22aaa7aba42a53" PRIMARY KEY ("brand_id"))`);
        await queryRunner.query(`CREATE TABLE "tbl_booking" ("booking_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "booking_date" TIMESTAMP NOT NULL, "return_date" TIMESTAMP NOT NULL, "booking_status" character varying NOT NULL, "message" character varying NOT NULL, "user_id" uuid, "motor_id" uuid, CONSTRAINT "PK_2b3cdc02ffc2be2a2300e2b8c43" PRIMARY KEY ("booking_id"))`);
